    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('paid_course', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='studing.course', verbose_name='оплаченный курс')),
                ('paid_lesson', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='studing.lesson', verbose_name='оплаченный урок')),
